...
# built documents.
#
project_VERSION = "project(docs-test VERSION "
release = None
for l in open ("../CMakeLists.txt"):
  if l.startswith (project_VERSION):
    release = l.split (' ')[2]
    break
if release == None:
  print ("Error in conf.py: can't find docs-test VERSION in ../CMakeList.txt")
  exit(-1)
...
html_title = "Docs-Test Documentation"
